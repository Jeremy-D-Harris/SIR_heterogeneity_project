function [] = plt_distributions(eps_plt,del,joint_S,joint_I,marg_eps_S,marg_delta_S,marg_eps_I,marg_delta_I, my_rgb_colors)
...
p(2)=plot(del, marg_delta_S,'.-','Color',my_rgb_colors(2,:),'LineWidth',2.5,'MarkerSize',20); hold on;
...
q(2)=plot(del, marg_delta_I,'.-','Color',my_rgb_colors(2,:),'LineWidth',2.5,'MarkerSize',20); hold on;
% cat_margs = [marg_eps_S;marg_delta_S];
% q=bar(eps,cat_margs);
axis([0 4.5 0 1]);
