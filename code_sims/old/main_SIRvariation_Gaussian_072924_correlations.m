...
% -0.395, -0.21, 0.202, 0.375
set_corr_coeff = 0.375;

% target values are:
% -0.6 -0.3 0.3 0.6

% set corresponding mean eps in S:
% 0.62, 0.57, 0.495, 0.47
set_mean_eps_S = 0.47;

% set corresponding mean delta in S:
% 1.0, 0.93, 0.8, 0.75
set_mean_delta_S = 0.75;
...
params.corr_coeff = set_corr_coeff
