...
if readin_init_joint
    ...
    init_joint_I = zeros(size(init_joint_S));
    ...
    init_joint_I(ind_delta(1),ind_eps(1)) = 1/dx/dx;
...
% total incidence
total_incidence = bet*mean_delta_I_traj.*I_traj.*mean_eps_S_traj.*S_traj/N;
...
if run_classic_SIR
    ...
    % total incidence
    total_incidence_classic = bet*I_traj_SIR_classic.*S_traj_SIR_classic/params.N;
