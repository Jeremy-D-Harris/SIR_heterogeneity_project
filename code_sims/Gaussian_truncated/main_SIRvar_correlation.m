...
delta_S = 0.925; % starting mean transmissibility of susceptible population
delta_I = 0.925; % starting mean transmissibility of infectious population
epsilon_S =0.925;% starting mean susceptibility of susceptible population
epsilon_I =0.925;
